# <img src="keycloak/themes/cloudnative-theme/login/resources/img/favicon.svg" width="32" height="32" style="vertical-align:middle" alt="logo"/> Cloud Native Demo — Keycloak
...
Projeto criado para aulas sobre autenticação em ambientes cloud native. Demonstra na prática o fluxo **Authorization Code + PKCE**, gerenciamento de tokens (refresh, introspeção, revogação) e **SSO** com múltiplas aplicações — tudo rodando localmente via Docker Compose.

A stack inclui um backend Node.js com Swagger, um frontend React com visualização interativa de JWTs, e o **Grafana** autenticando via Keycloak para ilustrar SSO real entre sistemas distintos.
